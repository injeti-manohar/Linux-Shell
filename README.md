...
This repository contains the codes of Shell Scripts created during practice of HackerRank problems.
...
```
$ git clone "https://github.com/<username>/Linux-Shell"
```
...
```
$ git remote add main "https://github.com/kshitizsaini113/Linux-Shell"
```
